(function () {
    ...
    app.controller('GlobalCtrl', [
        "$scope", '$timeout', '$sce', '$compile', function ($scope, $timeout, $sce, $compile) {
            ...
            $scope.validateCreditCard = function (credit_card) {
                ...
                if ($.trim(credit_card.name) == '' || credit_card.name.replace(/ /g, '') == '' ) {
            ...
            $scope.submitCreditCard = function (credit_card) {
                if ($.trim(credit_card.error_message) == '') {
                    var token_data = {name: credit_card.name};

                    stripe.createToken(credit_card.card_number, token_data).then(function (result) {
                        $timeout(function () {
                            if (result.error) {
